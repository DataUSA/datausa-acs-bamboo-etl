...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        list_apis = [
            DICT_APIS['acs_ygst_gender_of_workers_by_transportation_to_work_1'], 
            DICT_APIS['acs_ygst_gender_of_workers_by_transportation_to_work_2']
        ]

        def transform_by_zone(year, geo, estimate, apis, api_key):
            df = read_file('/Users/jelmyhermosilla/Desktop/Datawheel/datausa/datausa-acs-bamboo-etl/acs/data/B08006_2014.csv') if str(year) == '2014' and estimate == '1' and geo == 'us' else read_by_zone(year, geo, estimate, apis, api_key)
...
class AcsYgstGenderOfWorkersByTransportationToWorkPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
...
if __name__ == '__main__':
    acs_pipeline = AcsYgstGenderOfWorkersByTransportationToWorkPipeline()
    for estimate in ['1', '5']:

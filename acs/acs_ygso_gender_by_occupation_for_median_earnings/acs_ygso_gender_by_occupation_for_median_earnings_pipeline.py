...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        list_apis = [
            DICT_APIS['acs_ygso_gender_by_occupation_for_median_earnings_1'], 
            DICT_APIS['acs_ygso_gender_by_occupation_for_median_earnings_2'],
            DICT_APIS['acs_ygso_gender_by_occupation_for_median_earnings_3']
        ]
...
class AcsYgsoGenderByOccupationForMedianEarningsPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            ...
            dtype=dtype, pk=['geoid', 'dim_0', 'dim_1', 'dim_2', 'dim_3'], nullable_list=['mea_lvl_0', 'moe_lvl_0', 'mea_lvl_1', 'moe_lvl_1', 'mea_lvl_2', 'moe_lvl_2']
        )

        return [transform_step, load_step]
        
if __name__ == '__main__':
    acs_pipeline = AcsYgsoGenderByOccupationForMedianEarningsPipeline()
    for estimate in ['1', '5']:

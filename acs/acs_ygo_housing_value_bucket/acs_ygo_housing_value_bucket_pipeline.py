...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        list_apis = [
            DICT_APIS['acs_ygo_housing_value_bucket_1'], 
            DICT_APIS['acs_ygo_housing_value_bucket_2']
        ]
...
class AcsYgohousingValueBucketPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "acs_ygo_housing_value_bucket_{}".format(params.get('estimate')), db_connector, if_exists='append',

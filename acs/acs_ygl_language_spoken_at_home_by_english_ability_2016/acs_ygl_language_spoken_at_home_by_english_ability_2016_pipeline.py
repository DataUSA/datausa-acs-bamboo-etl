...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        list_apis = [
            DICT_APIS['acs_ygl_language_spoken_at_home_by_english_ability_2016_1'], 
            DICT_APIS['acs_ygl_language_spoken_at_home_by_english_ability_2016_2'],
            DICT_APIS['acs_ygl_language_spoken_at_home_by_english_ability_2016_3'], 
            DICT_APIS['acs_ygl_language_spoken_at_home_by_english_ability_2016_4']
        ]
...
class AcsYglLanguageSpokenAtHomeByEnglishAbility2016Pipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "acs_ygl_language_spoken_at_home_by_english_ability_2016_{}".format(params.get('estimate')), db_connector, if_exists='append',
            schema='acs', dtype=dtype, pk=['geoid', 'dim_0', 'dim_1'], nullable_list=['mea', 'moe']
        )

        return [transform_step, load_step]
        
if __name__ == '__main__':
    acs_pipeline = AcsYglLanguageSpokenAtHomeByEnglishAbility2016Pipeline()
    for estimate in ['1', '5']:

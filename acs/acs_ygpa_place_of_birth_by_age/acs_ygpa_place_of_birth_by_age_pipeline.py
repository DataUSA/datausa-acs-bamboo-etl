...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        def transform_by_zone(year, geo, estimate, apis, api_key):
            df = read_file('/datausa-acs-bamboo-etl/acs/data/B06001_2014.csv') if str(year) == '2014' and estimate == '1' and geo == 'us' else read_by_zone(year, geo, estimate, apis, api_key)

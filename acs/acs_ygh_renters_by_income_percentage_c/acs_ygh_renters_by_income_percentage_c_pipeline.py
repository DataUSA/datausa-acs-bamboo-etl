...
class AcsYghRentersByIncomePercentageCPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "acs_ygh_renters_by_income_percentage_c_{}".format(params.get('estimate')), db_connector, if_exists='append',
...
if __name__ == '__main__':
    acs_pipeline = AcsYghRentersByIncomePercentageCPipeline()
    for estimate in ['1']:

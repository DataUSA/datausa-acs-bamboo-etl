...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        df_final['mea_lvl_0'] = df_final.apply(lambda x: np.nan if x['dim_2'] in list_dim else x['mea_lvl_1'], axis=1)
        df_final['moe_lvl_0'] = df_final.apply(lambda x: np.nan if x['dim_2'] in list_dim else x['moe_lvl_1'], axis=1)

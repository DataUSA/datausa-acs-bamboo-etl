...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        list_apis = [
            DICT_APIS['acs_ygsi_gender_by_industry_for_median_earnings_1'], 
            DICT_APIS['acs_ygsi_gender_by_industry_for_median_earnings_2'],
            DICT_APIS['acs_ygsi_gender_by_industry_for_median_earnings_3']
        ]

        def transform_by_zone(year, geo, estimate, apis, api_key):
            df =  read_file('/Users/jelmyhermosilla/Desktop/Datawheel/datausa/datausa-acs-bamboo-etl/acs/data/B24032_2014.csv') if str(year) == '2014' and estimate == '1' and geo == 'us' else read_by_zone(year, geo, estimate, apis, api_key)
...
class AcsYgsiGenderByIndustryForMedianEarningsPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            ...
            schema='acs', dtype=dtype, pk=['geoid', 'dim_0', 'dim_1', 'dim_2'], nullable_list=['mea_|v|_0', 'moe_|v|_0', 'mea_|v|_1', 'moe_|v|_1']
        )

        return [transform_step, load_step]
        
if __name__ == '__main__':
    acs_pipeline = AcsYgsiGenderByIndustryForMedianEarningsPipeline()
    for estimate in ['1', '5']:

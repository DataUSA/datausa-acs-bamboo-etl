...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        def transform_by_zone(year, geo, estimate, apis, api_key):
            df = read_file('/Users/jelmyhermosilla/Desktop/Datawheel/datausa/datausa-acs-bamboo-etl/acs/data/B05004_2014.csv') if str(year) == '2014' and estimate == '1' and geo == 'us' else read_by_zone(year, geo, estimate, apis, api_key)
...
class AcsYgcMedianAgeCitizenshipStatusByGenderPipeline(EasyPipeline):
    @staticmethod
    def parameter_list():
        return[
    ...
    def steps(params):
        ...
        load_step = LoadStep(
            "acs_ygcs_median_age_by_citizenship_status_by_gender_{}".format(params.get('estimate')), db_connector, if_exists='append',
...
if __name__ == '__main__':
    acs_pipeline = AcsYgcMedianAgeCitizenshipStatusByGenderPipeline()
    for estimate in ['1', '5']:

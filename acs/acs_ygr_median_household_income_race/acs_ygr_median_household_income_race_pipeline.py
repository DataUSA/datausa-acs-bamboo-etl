...
class TransformStep(PipelineStep):
    def run_step(self, prev, params):
        ...
        def transform_by_zone(year, geo, estimate, apis, api_key):
            df = read_multiple_files('/home/deploy/datausa-acs-bamboo-etl/acs/data/B19013/B19013', ['0', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I']) if str(year) == '2014' and estimate == '1' and geo == 'us' else read_by_zone(year, geo, estimate, apis, api_key)
